    ...
    return (
        <div id="portfolio" className="portfolio-wrapper">
            <div className="container">
                ...
                <h2 className="text-center py-5" style={{color:"#ffff", textDecorationLine: 'underline', textDecorationStyle: 'solid'} }>Some cool systems I have programmed</h2>
                <div className="image-box-wrapper row justify-content-center">
                    ...
                    <h2 className="text-center py-5" style={{color:"#ffff", textDecorationLine: 'underline', textDecorationStyle: 'solid'} }>Some cool materials and VFX I have created</h2>
                <div className="image-box-wrapper row justify-content-center">
